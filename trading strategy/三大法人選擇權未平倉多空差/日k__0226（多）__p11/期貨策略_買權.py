...
sql = "SELECT table_a.date, SUM(table_a.long_oi_value) AS long, SUM(table_a.short_oi_value) AS short\
        ...
        WHERE table_b.long_oi_value+table_a.short_oi_value!=0 AND table_a.cp='c' AND table_a.cp!=table_b.cp\
...
threebig_mc_diff.to_csv('big3_diff_call_value.csv' , index=False)
